...
describe('POST /todos', () => {
    ...
    describe('PATCH /todos/:id', () => {
        it('should update the todo', (done) => {
            ...
            request(app)
                .patch(`/todos/${hexId}`)
                .set('x-auth', users[0].tokens[0].token)
                .send({text, completed: true}).expect(200)
                .expect((res) => {               
                 ...
                 .end((err, res) => {
                    ...
                    // in kurs nicht geprüft (added by may)
        ...
        it('should not update the todo if not created by other user', (done) => {
            var hexId = todos[0]._id.toHexString();
        ...
        it('should clear completedAt when todo is not completed', (done) => {
            ...
            request(app)
                .patch(`/todos/${hexId}`)
                .set('x-auth', users[1].tokens[0].token)
                .send({text, completed: false}).expect(200)
                .expect((res) => {
                    expect(res.body.todo.text).toBe(text);
    ...
    describe('GET /users/me', () => {
        ...
        it('should return 401 if not authenticated', (done) => {
            ...
            .expect(401)
            .expect((res) => {
                expect(_.isEmpty(res.body)).toBe(true);
            })
            .end(done);
        });
     });
     ...
     describe('POST /users', () => {
        ...
        it('should return validation erros if request invalid', (done) => {
            var email = 'andreas.mayr@cable.vol.at';
            var password = '123mnb!';
